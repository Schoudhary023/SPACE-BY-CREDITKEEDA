...
// Only these events are persisted to Supabase for dashboard queries.
// Everything else is logged to console only (Railway log streaming).
...
function track(eventType, telegramId, properties = {}) {
  ...
  // Always emit to console — captured by Railway log streaming
